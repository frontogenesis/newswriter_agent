...
@CrewBase
class NewsWriter():
	"""Crew for writing news articles"""
	...
	def file_write_task(self) -> Task:
		return Task(
			...
			context=[self.ai_news_write_task()]
		)
	...
	def crew(self) -> Crew:
		...
		return Crew(
			...
			verbose=True,
			# process=Process.hierarchical, # In case you wanna use that instead https://docs.crewai.com/concepts/crews#hierarchical-process
		)
